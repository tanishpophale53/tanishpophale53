...
**Core**
`Java` `Spring Boot` `Kafka` `Redis` `PostgreSQL` `MySQL` `Docker` `AWS`
...
- ☁️ Secure file uploads with **AWS pre-signed URLs**
...
Backend systems built for reliable payment handling and reconciliation.
